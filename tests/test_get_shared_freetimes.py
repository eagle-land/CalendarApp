...
def test1():
    ...
    freeevents = []
    freeevent = calendar.Event("2019-04-15T11:51:00-04:00", "2019-04-15T11:59:00-04:00")
    freeevents.append(freeevent)
    freecalendar = calendar.Calendar(freeevents)

    rangestart = event1.starttime
    rangeend = event2.endtime
    assert calendar.get_shared_freetimes(rangestart, rangeend, calendar1, calendar2) == freecalendar
